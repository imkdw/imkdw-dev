...
import { Heart, Reply, MoreHorizontal, Send, Copy, Flag, Trash2, Edit3, UserX } from 'lucide-react';
...
const CommentItem = ({ comment, onReply, onLike, onDelete, onEdit, depth = 0, currentUserId = 'currentuser' }: CommentItemProps) => {
  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      content: 'React Server Components에 대한 정말 좋은 글이네요! 특히 성능 최적화 부분이 인상적입니다.',
      timestamp: '2시간 전',
      likes: 12,
      isLiked: false,
      replies: [
    ...
    },
    {
      ...
      content: '구현 예제가 정말 실용적이네요. 실제 프로덕션에서 사용할 수 있는 코드들이라 도움이 많이 됩니다.',
      timestamp: '3시간 전',
      likes: 8,
      isLiked: false
    }
