...
const DEFAULT_TITLE = '@imkdw-dev/toy';
const DEFAULT_DESCRIPTION = '개발에 필요한 유틸리티 도구 모음';
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span style={{ color: OG_CONFIG.colors.primary }}>~/imkdw-dev/toy</span>
                <span style={{ color: OG_CONFIG.colors.yellow }}>(main)</span>
                <span style={{ color: OG_CONFIG.colors.secondary }}>$</span>
                <div
                  style={{ width: '10px', height: '24px', background: OG_CONFIG.colors.primary, marginLeft: '6px' }}
                />
              </div>
