...
export const SERIES_EXCEPTION_MESSAGES_KO: Record<SeriesExceptionCode, string> = {
...
export const SERIES_EXCEPTION_MESSAGES_EN: Record<SeriesExceptionCode, string> = {
  [SERIES_EXCEPTION_CODES.SERIES_NOT_FOUND]: 'Series not found.',
  [SERIES_EXCEPTION_CODES.EXIST_SERIES_TITLE]: 'Series title already exists.',
  [SERIES_EXCEPTION_CODES.EXIST_SERIES_SLUG]: 'Series slug already exists.',
} as const;
